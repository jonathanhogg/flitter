...
BEAT = Vector.symbol('beat')[0]
TOGGLED = Vector.symbol('toggled')[0]
PUSHED = Vector.symbol('pushed')[0]
RELEASED = Vector.symbol('released')[0]
TOUCHED = Vector.symbol('touched')[0]
UNTOUCHED = Vector.symbol('untouched')[0]
